...
import { configureNetworkDiagnostics, diagnosticFetch } from './networkDiagnostics'
...
export const supabasePublicConfiguration = { url, anonKey }

if (url) configureNetworkDiagnostics(url)
